...
function GetIban() {
    ...
    if (!CheckIban(iban)) {
        result.innerHTML = "الايبان المدخل غير صحيح";
    } else {
        ...
        const samaCodeTitle = document.getElementById("samaCodeTitle");

        bn.innerHTML = "اسم البنك";
        bankresult.innerHTML = bankname ? bankname.nameAr : "";
        samaCodeTitle.innerHTML = "الكود الموحد للبنك";
